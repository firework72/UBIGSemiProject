            ...
            <div class="col-lg-3 mb-4">
                <div class="card shadow-sm">
                    ...
                    <div class="list-group list-group-flush sidebar-menu" id="myMenu">
                        <button id="myupdate" class="list-group-item list-group-item-action active">내 정보 수정</button>
                        <button id="myvolunteer" class="list-group-item list-group-item-action">봉사 신청 내역</button>
                        <button id="myadoption" class="list-group-item list-group-item-action">입양 신청 내역</button>
                        <button id="myboard" class="list-group-item list-group-item-action">내가 쓴 글</button>
                        
                        <form action="${pageContext.request.contextPath}/user/delete.me" method="post">
                            <button id="delete" class="list-group-item list-group-item-action text-danger" onclick="return deleteMember();">회원 탈퇴</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body p-4" id="myupdate2">
                        ...
                        <form action="${pageContext.request.contextPath}/user/update.me" method="post" id="updateForm">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="userName" id="userName" maxlength="10" value="${loginMember.userName}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="userNickname" id="userNickname" maxlength="10" value="${loginMember.userNickname}" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="userContact" id="userContact" maxlength="11" value="${loginMember.userContact}" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" class="form-control" id="detailAddress" maxlength="20" placeholder="상세 주소를 입력해주세요">
                            ...
                            <div class="d-flex justify-content-between">
                                <button type="submit" class="btn btn-primary fw-bold text-white px-4">정보 수정 저장</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body p-4" style="display: none;" id="myadoption2">
                        ...
                        <div class="input-group mb-3" style="max-width: 300px;">
                            <input type="text" id="searchKeyword" class="form-control" placeholder="동물 이름 검색">
                            <button class="btn btn-outline-secondary" type="button" onclick="getAdoptionData(1, currPage2)">검색</button>
                        </div>
