...
public interface VolunteerService {
	...
	// --- 댓글 관련 (봉사 프로그램) ---
    // [추가 사유] 봉사 프로그램 상세페이지 댓글 목록 조회
    List<VolunteerCommentVO> selectActivityReplyList(int actId);
    // [추가 사유] 봉사 프로그램 댓글 등록
    int insertActivityReply(VolunteerCommentVO r);

    // --- 댓글 관련 (봉사 후기) ---
    // [추가 사유] 봉사 후기 상세페이지 댓글 목록 조회
